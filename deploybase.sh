...
if test -d /home/utnso/PuntoMontaje/; then
    sudo rm -rf /home/utnso/PuntoMontaje
fi
...
echo -e "IP_BROKER=10.108.240.2
IP_TEAM=10.108.240.4
IP_GAMECARD=10.108.240.3
IP_GAMEBOY=10.108.240.2
PUERTO_BROKER=5003
PUERTO_TEAM=5002
